...
export const signCookie = cookieParser(process.env.COOKIE_SECRET || 'set_a_cookie_secret_please');
...
export const registerUser = async (req, res) => {
  try {
    ...
    return res.status(201).json({ user: { id: user.id, email: user.email }, ...userTokens });
  } catch (e) {
